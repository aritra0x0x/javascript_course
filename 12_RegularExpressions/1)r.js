...
let reg = /bhatta/; // This is a regular expression literal in js
// reg = /bhatta/g; // g means global
// reg = /bhatta/i; // i means case insensitive

// console.log(reg);
// console.log(reg.source);  // inside the literal will print (bhatta)

let s = "This is great code with bhatta and also bhatta bhai";
